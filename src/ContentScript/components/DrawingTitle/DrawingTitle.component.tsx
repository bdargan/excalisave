      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            if (
              btnAtClick &&
              typeof btnAtClick.getBoundingClientRect === "function"
            ) {
          ...
          (async () => {
            ...
            if (
              ...
              try {
                ...
                if (
                  again &&
                  typeof again.getBoundingClientRect === "function"
                ) {
            ...
            try {
              ...
              if (sz && typeof sz.w === "number" && typeof sz.h === "number") {
                ...
                popupW = Math.max(
                  popupW,
                  Math.min(sz.w, window.innerWidth - 24)
                );
                popupH = Math.max(
                  minH,
